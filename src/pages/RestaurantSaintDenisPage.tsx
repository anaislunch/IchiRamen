...
export default function RestaurantSaintDenisPage() {
  return (
    <div>
      {/* HERO */}
      <section className="texture-dark relative overflow-hidden" style={{ minHeight: '60vh', display: 'flex', alignItems: 'flex-end' }}>
        <div style={{ position: 'absolute', inset: 0 }}>
          <ImagePlaceholder label="ICHI RAMEN Saint-Denis — Façade" style={{ width: '100%', height: '100%' }} />
        </div>
        <div
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pb-16 w-full">
          <span className="stamp text-xs mb-4 inline-block">75002 Paris — Saint-Denis</span>
            ...
            <div>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-oswald font-semibold" style={{ color: 'var(--black)' }}>135 Rue Saint-Denis</p>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Link to="/menu-saint-denis" className="btn-outline-dark">
      ...
      <section className="texture-dark clip-skew py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { label: 'Ambiance', text: 'Une décoration immersive inspirée des mangas japonais, avec des œuvres originales et une atmosphère chaleureuse.', kanji: '雰', num: '01' },
              { label: 'Cuisine', text: 'Des ramens préparés chaque jour avec des bouillons mijotés 12 heures, des ingrédients de qualité et des recettes authentiques.', kanji: '料', num: '02' },
              { label: 'Accueil', text: 'Un service chaleureux et attentionné, où chaque client est reçu comme un invité. L\'accueil fait partie de notre identité.', kanji: '歓', num: '03' },
            ].map((item) => (
      ...
      <section className="texture-paper py-16 text-center">
        <div className="max-w-xl mx-auto px-4">
          ...
          <p className="font-typewriter mb-8" style={{ color: 'rgba(14,12,10,0.5)' }}>
            Réservez votre table au ICHI RAMEN Saint-Denis dès maintenant.
          </p>
